...
public class TestMonstre {
    ...
    public void test2_bougerMonstre() throws IOException {
        ...
        assertEquals(labyJeu.getMonstre().get(0).etrePresent(labyJeu.getMonstre().get(0).getPos().getX(), labyJeu.getMonstre().get(0).getPos().getY()), false, "Le monstre aurait du changer d'emplacement");
    }
}
